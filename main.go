...
import (
	...
	"github.com/sentinel-official/sentinel-dvpncli/query"
	"github.com/sentinel-official/sentinel-dvpncli/service"
	"github.com/sentinel-official/sentinel-dvpncli/tx"
)
...
func main() {
	exitCode := app.Run(context.Background(), NewRootCmd)
	os.Exit(exitCode)
}
